part of 'homepage_cubit.dart';
 ...
 class HomepageState extends Equatable{
  ...
  const HomepageState({ this.isSideBarOpen = true,
  //  this.isQuestionType = false,this.questionList = const [], this.questionAnswerList = const []
   });
  ...
  //  isQuestionType, questionList, questionAnswerList
   ];
}
